...
<div id="content" class="main-content">
    ...
    max-height: 234.562px;
    overflow: hidden;
    min-height: 136px;
    will-change: transform;
    position: absolute;
    /* transform: translate3d(0px, -552px, 0px); */
    transform:none;
    top: 0px;
    left: 0px;
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-4 mt-4">
                                                    ...
                                                    <div class="input-group">
                                                        <select style="border: 1px solid #bfc9d4;" type="button" class="form-control btn-group bootstrap-select input-group-btn" name="acct_type"  data-width='100%'
                                                            required>
